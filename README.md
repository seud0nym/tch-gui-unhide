...
Execute this command on your DJA0231 via a PuTTY session or equivalent (an active WAN/Internet connection is required):

```
wget https://raw.githubusercontent.com/seud0nym/tch-gui-unhide/master/tch-gui-unhide-DJA0231-18.1.c.0514 
```
