...
$("#save-config,.btn-table-add,.btn-table-edit,.btn-table-delete,.btn-table-modify,.btn-table-cancel,.btn-table-new,ul.nav li a:not([id^='wifianalyzer'])").on("click",showLoadingWrapper);
