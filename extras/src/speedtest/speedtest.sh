...
MOD
    ...
    sed \
      -e '/diagnostics-ping-modal\.lp/i\      <div class="diag-icon" data-toggle="modal" data-remote="modals/diagnostics-speedtest-modal.lp" data-id="diagnostics-speedtest-modal" title="SPEEDTEST®"><img data-original-title="SPEEDTEST" alt="speedtest" class="diag-speedtest"></div>\\' \
